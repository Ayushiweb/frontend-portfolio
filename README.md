...
📍 **Noida, India**\
📧 **ayushisahu415@gmail.com**\
📱 **+91 9653088436**\
🔗 **[LinkedIn](https://www.linkedin.com/in/ayushi-sahu1999)**\
🔗 **[GitHub](https://github.com/Ayushiweb)**
...
high‑performance **Angular applications (Angular 12--15)** using
TypeScript, RxJS, SCSS, and modern architecture. Skilled in state
management (NgRx), reactive programming, reusable component libraries,
REST API integration, and WCAG‑compliant UI/UX. Passionate about clean
code, performance optimization, and meaningful user experiences.
...
-   REST APIs, Interceptors, Async Data Handling, Postman
...
-   VS Code, Chrome DevTools, Prettier, Husky, CleverTap
